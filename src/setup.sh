...
( cd "$TEMP_FOLDER/protobuf-build" && cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE:STRING=Release -Dprotobuf_BUILD_TESTS:BOOL=false -Dprotobuf_BUILD_SHARED_LIBS:BOOL=true "$PACKAGE_FOLDER/protobuf/cmake")
